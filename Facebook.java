class Facebook{
	...
	public static boolean registerUser(String email,String fName,String lName,String pwd,String cPwd){
		...
		boolean userValidated=FacebookUserValidator.validateFacebookUser(email,fName,lName,pwd,cPwd);
		if(userValidated) isUserRegistered=true;
		return isUserRegistered;
	}
	
	public static void getUserInfo(){
		firstName=FacebookUserValidator.firstName;
		lastName=FacebookUserValidator.lastName;
		emailId=FacebookUserValidator.emailId;
		password=FacebookUserValidator.password;
		confirmPassword=FacebookUserValidator.confirmPassword;
		System.out.println();
