class CrackersRunner{
	public static void main(String[] carckers){
		...
		Crackers crackerOne=new Crackers(1,"Flowerpot","Spark","Potassium nitrate",45,100.0);
		...
		Crackers crackerTwo=new Crackers(2,"Ground Chakra","Spinner","Aluminium powder",30,80.0);
		...
		Crackers crackerThree=new Crackers(3,"Rocket","Aerial","Black powder",75,150.0);
		...
		Crackers crackerFour=new Crackers(4,"Ladi","Series","Flash powder",95,200.0);
		...
		Crackers crackerSix=new Crackers(6,"Pencil Sparkler","Spark","Magnesium",20,30.0);
		...
		crackerSix.getCrackersInfo();	
			
		Crackers crackerSeven=new Crackers(7,"Colorful Rocket","Aerial","Strontium nitrate",70,160.0);
		...
		Crackers crackerEight=new Crackers(8,"Chakri","Spinner","Iron filings",35,60.0);
		...
		Crackers crackerNine=new Crackers(9,"Bijli","Small","Flash powder",85,40.0);
		...
		Crackers crackerTen=new Crackers(10,"Sky Shot","Aerial","Zinc sulphide",65,180.0);
		...
		Crackers crackerEleven=new Crackers(11,"Butterfly","Spinner","Aluminium and sulphur",50,90.0);
		...
		Crackers crackerTwelve=new Crackers(12,"Snake Tablet","Effect","Sugar and baking soda",10,25.0);
		...
		Crackers crackerThirteen=new Crackers(13,"Whistling Rocket","Aerial","Potassium perchlorate",78,170.0);
		...
		Crackers crackerFourteen=new Crackers(14,"Deluxe Flowerpot","Spark","Barium nitrate",55,130.0);
		...
		Crackers crackerFifteen=new Crackers(15,"Thunder Bomb","Loud","Red phosphorous",115,260.0);
		...
		Crackers crackerSixteen=new Crackers(16,"Mini Ladi","Series","Flash powder",65,90.0);
		...
		Crackers crackerSeventeen=new Crackers(17,"Color Fountain","Spark","Strontium carbonate",25,110.0);
		...
		Crackers crackerEighteen=new Crackers(18,"Garland Bomb","Series","Potassium nitrate",105,230.0);
		...
		Crackers crackerNineteen=new Crackers(19,"Laser Rocket","Aerial","Magnesium and oxidizers",90,190.0);
		...
		Crackers crackerTwenty=new Crackers(20,"Eco-friendly Pot","Spark","Low-emission chemicals",40,120.0);
