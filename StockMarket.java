class StockMarket{
	...
	static String vernova="GE Vernova T&D";
	...
	public static void main(String stock[]){
			...
			String vernova="GE Vernova T&D";
			String nippon="Nippon Life Ind.";
			
		String stockNames[]={relianceIndustries,hygiene,colgate,glasmoxi,gillette,castrol,britannia,hyundai,vernova,nippon};
