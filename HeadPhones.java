...
public static void main(String headsets[]){
	System.out.println("* 70H Playtime:Boult Mustang Q wireless over-ear headphones offer an impressive 70 hours battery life,ensuring non-stop music,calls,or gaming without frequent charging interruptions.");
	...
	System.out.println("* 4 EQ Modes:Customize your sound with 4 EQ modes- Bass,Rock,Pop,and Vocal,fine-tuning your experience for different music genres.");
