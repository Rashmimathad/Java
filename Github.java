class Github{
	...
	public static boolean registerUser(String email,String fName,String lName,String pwd,String cPwd){
		...
		boolean userValidated=GithubUserValidator.validateGithubUser(email,fName,lName,pwd,cPwd);
	...
	public static void getUserInfo(){
		firstName=GithubUserValidator.firstName;
		lastName=GithubUserValidator.lastName;
		emailId=GithubUserValidator.emailId;
		password=GithubUserValidator.password;
		confirmPassword=GithubUserValidator.confirmPassword;
		System.out.println();
