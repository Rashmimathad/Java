class Tourism{
	...
	public static void main(String tourism[]){
		...
		String touristPlaces[]={mysuru,tajMahal,ooty,charminar,kedarnath,puriJagannadh,badrinath,aihole,badami,pattadakallu,hampi,anjanadri,madikeri,udupi,murudeshwara};
